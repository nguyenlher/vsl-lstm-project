"""
Vietnamese Sign Language Recognition - Desktop Application
Using PyQt5 + MediaPipe Holistic + BiLSTM

This is a standalone desktop version of the Sign Language Recognition app.
"""
...
def normalize_sequence(sequence):
    """Min-max normalization to match training preprocessing."""
    if not sequence:
        return sequence
...
def smooth_keypoints(sequence, window_size=3):
    """Apply moving average to smooth webcam jitter."""
...
class SignLanguageApp(QMainWindow):
    ...
    def load_resources(self):
        ...
        try:
            ...
            model_path = os.path.join(base_dir, "models", "test_model.keras")
            label_path = os.path.join(base_dir, "dataset", "label", "label_test.json")
    ...
    def update_webcam_frame(self):
        """Process and display webcam frame."""
        if not self.webcam_running:
            return
    ...
    def display_frame(self, frame, label):
        """Convert and display OpenCV frame in QLabel."""
